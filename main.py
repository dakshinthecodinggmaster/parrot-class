...
class parrot:
    species="rainforest tropical yellow horned parrot"
    def __init__(self,name,age):
        self.name=name
        self.age=age
    def display(self):
        print("My parrot's name is",self.name,"and he is",self.age,"years old and he is one of the rarest species called",self.species,".")
r=parrot("Bucky",200)
r.display()